...
def convert_gt_to_loc(gt_path, geotransform_path, save_path, prefix="uav/", image_ext=".jpg"):
    ...
    target_srs.ImportFromEPSG(3857)  # 投影坐标
...
if __name__ == "__main__":
    gt_path = "/home/lty/datasets/RealUAV/city1/gt.txt"
    geotransform_path = "/home/lty/datasets/RealUAV/city1/geotransform.txt"
    save_path = "/home/lty/outputs/RealUAV/city1/loc_from_gt.txt"
