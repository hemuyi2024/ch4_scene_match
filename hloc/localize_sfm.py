...
def main(
    ...
    print("Retrieval dictionary content:")
    for qname, db_names in retrieval_dict.items():
        print(f"Query image: {qname}, Retrieved images: {db_names}")
    ...
    for qname, qcam in tqdm(queries):
        ...
        if covisibility_clustering:
            ...
            if ret is not None:
                ...
                print(f"Failed to localize {qname}. Using closest image.")
