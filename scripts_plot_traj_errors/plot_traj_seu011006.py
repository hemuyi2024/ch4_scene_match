...
def plot_trajectories(file_list, legend_labels, output_path="trajectory_plot.png"):
    ...
    ax.xaxis.set_major_locator(ticker.MultipleLocator(90))  # 每50米一格
    ...
    plt.legend(fontsize=16, loc='center',edgecolor='black',)
    plt.grid(True)
    plt.axis('equal')
    plt.tight_layout()
...
if __name__ == "__main__":
    trajectory_files = [
        #052409
        "/home/lty/paper/results/011006/traj0603/gt.txt",
        "/home/lty/paper/results/011006/traj0603/elevpnp.txt",
        "/home/lty/paper/results/011006/traj0603/slam.txt",
        "/home/lty/paper/results/011006/traj0603/proposed.txt",
    ...
    plot_trajectories(
        trajectory_files,
        legend_labels,
        output_path="/home/lty/paper/results/011006/traj_compare0603.png"
    )
