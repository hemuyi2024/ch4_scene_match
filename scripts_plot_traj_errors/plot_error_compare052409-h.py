...
def plot_broken_axis(error_files, save_path="broken_error.png", labels=None):
    ...
    ax_lower.grid(True)
    ax_upper.grid(True)
    ax_upper.legend(loc='upper right', frameon=True, edgecolor='black').get_frame().set_linewidth(1.0)
...
if __name__ == "__main__":
    ...
    error_files = [
        ...
        "/home/lty/paper/results/052409/errors/h.txt",
    ]
    labels = ["Proposed", "Homography-based"]

    plot_broken_axis(
        error_files,
        save_path="/home/lty/paper/results/052409/h_error_compare0603.png",
        labels=labels
    )
