...
def plot_multi_error_files_jubufangda(error_files, save_path="error_compare.png", y_limit=(0, 20), labels=None):
    ...
    # 连接放大图和主图
    mark_inset(axs[2], axins, loc1=2, loc2=4, fc="none", ec="0.3", lw=1)
...
if __name__ == "__main__":
    ...
    #     error_files,
    #     save_path="/home/lty/paper/results/052409/error_compare_broken_strict.png",
    #     labels=labels,
    #     elevpnp_file=error_files[0],
    #     orbslam_file=error_files[1],
    # )

    plot_multi_error_files_jubufangda(error_files, save_path="/home/lty/paper/results/052409/error_compare0603-0613.png",
                           labels=labels)
