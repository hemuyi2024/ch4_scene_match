...
if __name__ == "__main__":
    ...
    error_files = [
        ...
        "/home/lty/paper/results/city1/errors/elevpnp.txt",
        "/home/lty/paper/results/city1/errors/slam.txt",
        "/home/lty/paper/results/city1/errors/proposed.txt",
    ]

    # 自定义图例名称（将作为图例显示内容）
    labels = ["ElevPnP", "ORB-SLAM3","Proposed"]

    plot_multi_error_files(error_files, save_path="/home/lty/paper/results/city1/error_compare0613.png", y_limit=(0, 100), labels=labels)
