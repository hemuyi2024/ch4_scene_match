...
def plot_trajectories(file_list, legend_labels, output_path="trajectory_plot.png"):
    ...
    custom_colors = [
        ...
        (0.8, 0.2, 0.2),   # H
        # (0.1, 0.6, 0.1),   # Ours
        # (0.8, 0.2, 0.2),   # Ours (alternative)  red
        # (0.9, 0.5, 0.1),   # Ours (alternative) yellow
        # (0.1, 0.1, 0.1),   # Ours (alternative) black
        # (0.8, 0.8, 0.8)    # Ours (alternative)  gray
    ]
...
if __name__ == "__main__":
    trajectory_files = [
        ...
        # "/home/lty/paper/results/052409/traj_1.0/elevpnp.txt",
        ...
        "/home/lty/paper/results/052409/traj_1.0/groudtruth.txt",
        "/home/lty/paper/results/052409/traj_1.0/elevpnp.txt",
        "/home/lty/paper/results/052409/traj_1.0/H.txt",
    ]
    ...
    plot_trajectories(
        trajectory_files,
        legend_labels,
        output_path="/home/lty/paper/results/052409/traj_compareH.png"
    )
