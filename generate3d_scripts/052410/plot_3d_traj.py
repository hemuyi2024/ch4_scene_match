...
def plot_trajectories(file_list, legend_labels, output_path="trajectory_plot_3d.png"):
    ...
    yticks = np.linspace(min(all_y), max(all_y), 4)  # 设置 5 个刻度
...
if __name__ == "__main__":
    trajectory_files = [
        "/home/lty/paper/results/052410/traj0603(3d)/gt(3d)_minus8.txt",
    ...
    plot_trajectories(
        trajectory_files,
        legend_labels,
        output_path="/home/lty/paper/results/052410/traj_compare0603_3d.png"
    )